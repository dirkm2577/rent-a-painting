...
user1 = User.create(email: "dee2577@gmail.com", password: "123456")

file = URI.open("https://res.cloudinary.com/dach7c7ct/image/upload/v1667645216/Girl_with_a_Pearl_bmjbeu.jpg")
painting = Painting.new(name: "Girl with a Pearl", description: "Johannes Vermeer’s 1665", price: 100, user: user1)
